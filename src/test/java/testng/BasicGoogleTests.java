...
public class BasicGoogleTests extends Tests{
    ...
    public void quickGoogleSearch(){
        ...
        By searchingArea = By.id("APjFqb");
        bot.type(searchingArea , "Selenium WebDriver" + Keys.RETURN);

        // Assert the result stats
        By resultStats = By.id("result-stats");
        Assert.assertNotEquals(driver.findElement(resultStats).getText(), "");
    ...
    public void assertGoogleLogo(){
        ...
        bot.navigate("https://www.google.com/");
        By googleLogo = By.cssSelector("img[alt='Google']");
